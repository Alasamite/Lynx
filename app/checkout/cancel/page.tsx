  ...
  return (
    <main className="min-h-screen bg-lynx-black px-4 py-12 text-lynx-chalk">
      <section className="mx-auto max-w-3xl border border-lynx-graphite bg-lynx-charcoal p-6">
        ...
        <h1 className="mt-3 text-3xl font-bold uppercase tracking-wide">PayPal payment cancelled</h1>
        <p className="mt-4 text-sm leading-6 text-lynx-granite">Your cart remains available. Return to checkout when you are ready to complete payment with PayPal.</p>
